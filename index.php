            ...
            <div class="nav-right">
                ...
                <?php if(isset($_SESSION['giris_yapildi'])): ?>
                    ...
                    <?php if(isset($_SESSION['rol']) && $_SESSION['rol'] == 'admin'): ?>
                        <a href="admin.php" class="admin-box" style="background-color: #e67e22; color: white;">⚙ Admin Panel</a>
                    
                    <?php else: ?>
                        <span style="color: #2c3e50; font-weight: bold; margin-right: 15px;">👤 Xoş gəldin, <?= $_SESSION['ad_soyad'] ?></span>                    <?php endif; ?>
                    
                    <a href="logout.php" class="admin-box" style="background-color: #e74c3c; color: white;">🚪 Çıxış</a>
                    
                <?php else: ?>
                    
                    <a href="login.php" class="admin-box" style="background-color: #3498db; color: white;">🔑 Giriş / Qeydiyyat</a>
