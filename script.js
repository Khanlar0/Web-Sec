...
// --- SAHTE "DAHA ÇOX" BUTONU İŞLEMLERİ ---
   ...
   // --- YENİ: SİFARİŞ ET BUTONU (VERİTABANI BAĞLANTILI) ---
    ...
    if (sifarisBtn) {
        sifarisBtn.addEventListener("click", function() {
            ...
            // Arka planda veriyi sifaris_qeryd.php'ye gönder (AJAX/Fetch)
            ...
            .then(data => {
                if(data.durum === "basarili") {
                    alert("Təbriklər! Sifarişiniz uğurla bazaya (veritabanına) yazıldı.");
                    sepet = [];
                    sepetArayuzunuGuncelle();
            ...
            .finally(() => {
                sifarisBtn.innerText = "Sifarişiniz Qəbul Olundu";
